...
public class FirstFragement extends Fragment {
    ...
    public static String cityUser,DistrictUser,Jobuser = "";
    ...
    public void onStart() {
        try {
            ...
            FirebaseRecyclerAdapter<Post, ViewHolder> firebaseAdap = new FirebaseRecyclerAdapter<Post, ViewHolder>(
                    Post.class, R.layout.row, ViewHolder.class, ref2.orderByChild("fulltime")) {
                @Override
    ...
    public void ini(){
        ...
        closebtn = getView().findViewById(R.id.closebtnn);
