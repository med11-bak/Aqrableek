    ...
    public void onStart() {
        try {
            ...
            FirebaseRecyclerAdapter<Post, ViewHolder> firebaseAdap = new FirebaseRecyclerAdapter<Post, ViewHolder>(
                    Post.class, R.layout.row, ViewHolder.class,ref2.orderByChild("district").equalTo(FirstFragement.DistrictUser)) {
                @Override
                protected void populateViewHolder(ViewHolder viewHolder, Post model, int i) {
                    ...
                    Toast.makeText(getContext(), ""+FirstFragement.DistrictUser, Toast.LENGTH_SHORT).show();
                }
            };
